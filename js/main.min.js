...
/* harmony import */ var _modules_burger_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/burger.js */ "./js/modules/burger.js");
...
/* harmony import */ var _modules_swiper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/swiper */ "./js/modules/swiper.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_swiper__WEBPACK_IMPORTED_MODULE_3__["default"])();
  });
}); // ---------------------------------
...
// ** burger **//
var burgerToggle = document.querySelector('.page-header__toggle');

var changeToggle = function changeToggle() {
  var burgerMenu = document.querySelector('.page-header');
...
burgerToggle.addEventListener('click', changeToggle); // *menu *//

var burgerMenuItemList = document.querySelectorAll('.page-header__item');
var burgerMenu = document.querySelector('.page-header');

var burgerMenuItemClick = function burgerMenuItemClick() {
...
burgerMenuItemList.forEach(function (btn) {
...
var MoveTo = function () {
  ...
  MoveTo.prototype.move = function (target) {
    var _this2 = this; // eslint-disable-next-line no-undefined
...
var initSwiper = function initSwiper() {
  ...
  var swiperTeam = new Swiper('.team__swiper', {
    navigation: {
  ...
  var imageSlider = document.querySelector('.swiper').swiper;
  var clientsButtonPrev = document.querySelector('.clients__button-prev');
  var clientsButtonNext = document.querySelector('.clients__button-next'); // const gamesBtn = document.querySelector('.games__btn');
  // const promoButton = document.querySelector('.promo__unlim-link');

  var swiperSlides = document.querySelectorAll('.clients__swiper-slide');
  var firstSlide = imageSlider.slides[0];
  var lastSlide = imageSlider.slides[3];
  swiperSlides.forEach(function (swiperSlide) {
    swiperSlide.tabIndex = '0';
  });
  clientsButtonNext.addEventListener('click', function (evt) {
    if (imageSlider.isEnd) {//  console.log("сработал end", imageSlider.isEnd);
      //  evt.preventDefault();
      //firstSlide.focus();
...
/* harmony default export */ __webpack_exports__["default"] = (initSwiper);
